...
- Added `discoverDevices` config which allows you to enable device rediscover periodically.
  - Added `discoverDevicesInterval` config which allows you to set the Interval for the `discoverDevices` config.
