...
import { device, devicesConfig, serviceData, ad, deviceStatus, Devices } from '../settings';
...
export class Humidifier {
  ...
  async updateHomeKitCharacteristics(): Promise<void> {
    ...
    if (this.FirmwareRevision === undefined) {
      ...
      this.humidifierService.updateCharacteristic(this.platform.Characteristic.FirmwareRevision, this.FirmwareRevision);
      if (!this.device.humidifier?.hide_temperature) {
