...
import type { botServiceData as serviceData } from '../types/bledevicestatus.js'
import type { device } from '../types/devicelist.js'
import type { botStatus as deviceStatus } from '../types/devicestatus.js'
...
export class Bot {
  ...
  async deviceConfig(device: device & devicesConfig): Promise<void> {
    let config: Partial<devicesConfig> = {}
    if (device.bot) {
      config = device.bot
    }
