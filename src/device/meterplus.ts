...
export class MeterPlus extends deviceBase {
  ...
  async BLEparseStatus(): Promise<void> {
    ...
    await this.debugLog(`(temperature, humidity) = BLE:(${this.serviceData.temperature.c}, ${this.serviceData.humidity}),`
  ...
  async openAPIparseStatus(): Promise<void> {
    ...
    await this.debugLog(`(temperature, humidity) = OpenAPI:(${this.deviceStatus.temperature}, ${this.deviceStatus.humidity}),`
      + ` current:(${this.TemperatureSensor?.CurrentTemperature}, ${this.HumiditySensor?.CurrentRelativeHumidity})`);
  ...
  async registerWebhook() {
    if (this.device.webhook) {
      ...
      this.webhookEventHandler[this.device.deviceId] = async (context: meterPlusWebhookContext) => {
        try {
