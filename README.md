...
- US: [SwitchBot Mini Robot Vacuum K10+ Pro](https://www.switch-bot.com/products/switchbot-mini-robot-vacuum-k10-pro)
  - Enhanced features: Water Base Battery monitoring, Task Type status sensor
