#!/usr/bin/env bash
# Lightweight automated E2E helper for lights.
# Usage:
...
# 3) Run: `bash scripts/e2e/light-e2e.sh`
...
echo "Running light E2E script against $HB_URL (accessory $ACCESSORY_ID)"
...
echo "1) Fetch accessories listing (to verify connectivity)"
...
curl_common POST "/api/accessories/${ACCESSORY_ID}/characteristics" '{ "characteristics": [{"aid":1,"iid":12,"value":25}] }'
sleep 1

echo
echo "4) Set Brightness to 100%"
